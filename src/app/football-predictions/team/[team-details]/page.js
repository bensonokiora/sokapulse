      ...
      <div className="row" style={{ marginLeft: '0px', height: 'auto !important' }}>
        <div className="col-lg-12">
          ...
          <div className="responsive-row match-details-header-row">
            <div className="table-cell match-details-header-cell">
              <h1 className="match-details-header-title">
                {teamData?.team_name} Statistics and Predictions
              </h1>
            </div>
          </div>
              ...
              <div className="team-logo-wrapper">
                {teamData?.team_logo ? (
                  <img 
                    ...
                    alt={`${teamData?.team_name}-predictions-and-fixtures`}
                    className="team-logo"
                    onError={(e) => {
          ...
          <div className="responsive-row header-size" 
               style={{ fontWeight: 'bold', textAlign: 'left', cursor: 'auto', marginTop: '20px' }}>
          ...
          <TeamDetailsClient teamData={teamData} />
