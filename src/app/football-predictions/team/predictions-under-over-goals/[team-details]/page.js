...
import TeamUnderOverClient from '@/components/TeamUnderOverClient';

export default function TeamUnderOver() {
    ...
    <div className="container container-mob">
      ...
      <div className="row" style={{ marginLeft: '0px', height: 'auto !important' }}>
        <div className="col-lg-12">
          ...
          <div className="responsive-row match-details-header-row">
            <div className="table-cell match-details-header-cell">
              <h1 className="match-details-header-title">
                {teamData?.team_name} Over/Under 2.5 Goals Predictions
              </h1>
            </div>
          </div>
              ...
              <div className="team-logo-wrapper">
                {teamData?.team_logo ? (
                  <img 
                    ...
                    alt={`${teamData?.team_name}-over-under-predictions`}
                    className="team-logo"
                    onError={(e) => {
          ...
          <TeamUnderOverClient teamData={teamData} />
