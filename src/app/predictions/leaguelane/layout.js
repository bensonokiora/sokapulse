export const metadata = {
  title: 'leaguelane Football Predictions and Tips - sokapulse',
  ...
  keywords: 'leaguelane predictions, football tips, betting tips, football predictions, leaguelane football',
  openGraph: {
    title: 'leaguelane Football Predictions and Tips - sokapulse',
    type: 'website',
    url: '/predictions/leaguelane',
    images: [
      {
  ...
  twitter: {
    ...
    title: 'leaguelane Football Predictions and Tips - sokapulse',
    description: 'Get the latest leaguelane football predictions and tips for today\'s matches.',
    site: '@sokapulse'
  },
  alternates: {
    canonical: 'https://sokapulse.com/predictions/leaguelane'
  },
  other: {
    'article:publisher': [
...
export default function LeaguelaneLayout({ children }) {
  return <>{children}</>;
}