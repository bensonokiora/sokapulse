export const metadata = {
  title: 'Mathematical Mega Jackpot Prediction - 17 Games this Weekend',
  description: 'Get Sure Mega Jackpot Prediction this Weekend & increase your chances of winning the Mathematical Mega Jackpot - 17 games & bonuses this weekend',
  alternates: {
    canonical: 'https://sokapulse.com/predictions/mathematical-mega-jackpot-predictions'
  },
  openGraph: {
    title: 'Mathematical Mega Jackpot Prediction - 17 Games this Weekend',
    description: 'Get Sure Mega Jackpot Prediction this Weekend & increase your chances of winning the Mathematical Mega Jackpot - 17 games & bonuses this weekend',
    url: 'https://sokapulse.com/predictions/mathematical-mega-jackpot-predictions',
    siteName: 'SokaPulse',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Mathematical Mega Jackpot Predictions'
      }
    ],
    locale: 'en_US',
    type: 'website',
  ...
  keywords: ['Mathematical Mega Jackpot Predictions', 'football predictions', 'betting tips', 'sports analysis', 'jackpot betting', 'SokaPulse'],
  authors: [{ name: 'SokaPulse' }],
  colorScheme: 'light',
  viewport: {
    width: 'device-width',
  ...
  appleWebApp: {
    ...
    title: 'Mathematical Mega Jackpot Predictions - SokaPulse',
  },
  other: {
    'apple-mobile-web-app-capable': 'yes',
    'apple-mobile-web-app-status-bar-style': 'default',
    'apple-mobile-web-app-title': 'Mathematical Mega Jackpot Predictions - SokaPulse',
    'format-detection': 'telephone=no',
    'mobile-web-app-capable': 'yes',
    'application-name': 'Mathematical Mega Jackpot Predictions - SokaPulse',
  },
  datePublished: '2025-03-20T18:54:21+00:00',
  dateModified: new Date().toISOString(),
};

export default function MathematicalJackpotPredictionLayout({ children }) {
  return <>{children}</>;
} 