export const metadata = {
  title: 'sportus Football Predictions and Tips - sokapulse',
  ...
  keywords: 'sportus predictions, football tips, betting tips, football predictions, sportus football',
  openGraph: {
    title: 'sportus Football Predictions and Tips - sokapulse',
    type: 'website',
    url: '/predictions/sportus',
    images: [
      {
  ...
  twitter: {
    ...
    title: 'sportus Football Predictions and Tips - sokapulse',
    description: 'Get the latest sportus football predictions and tips for today\'s matches.',
    site: '@sokapulse'
  },
  alternates: {
    canonical: 'https://sokapulse.com/predictions/sportus'
  },
  other: {
    'article:publisher': [
...
export default function SportusLayout({ children }) {
  return <>{children}</>;
}