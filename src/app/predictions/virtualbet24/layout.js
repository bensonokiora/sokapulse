export const metadata = {
  title: 'virtualbet24 Football Predictions and Tips - sokapulse',
  ...
  keywords: 'virtualbet24 predictions, football tips, betting tips, football predictions, virtualbet24 football',
  openGraph: {
    title: 'virtualbet24 Football Predictions and Tips - sokapulse',
    type: 'website',
    url: '/predictions/virtualbet24',
    images: [
      {
  ...
  twitter: {
    ...
    title: 'virtualbet24 Football Predictions and Tips - sokapulse',
    description: 'Get the latest virtualbet24 football predictions and tips for today\'s matches.',
    site: '@sokapulse'
  },
  alternates: {
    canonical: 'https://sokapulse.com/predictions/virtualbet24'
  },
  other: {
    'article:publisher': [
...
export default function Virtualbet24Layout({ children }) {
  return <>{children}</>;
}