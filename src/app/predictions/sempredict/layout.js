export const metadata = {
  title: 'sempredict Football Predictions and Tips - sokapulse',
  ...
  keywords: 'sempredict predictions, football tips, betting tips, football predictions, sempredict football',
  openGraph: {
    title: 'sempredict Football Predictions and Tips - sokapulse',
    type: 'website',
    url: '/predictions/sempredict',
    images: [
      {
  ...
  twitter: {
    ...
    title: 'sempredict Football Predictions and Tips - sokapulse',
    description: 'Get the latest sempredict football predictions and tips for today\'s matches.',
    site: '@sokapulse'
  },
  alternates: {
    canonical: 'https://sokapulse.com/predictions/sempredict'
  },
  other: {
    'article:publisher': [
...
export default function SempredictLayout({ children }) {
  return <>{children}</>;
}