export const metadata = {
  title: 'odds-lot Football Predictions and Tips - sokapulse',
  ...
  keywords: 'odds-lot predictions, football tips, betting tips, football predictions, odds-lot football',
  openGraph: {
    title: 'odds-lot Football Predictions and Tips - sokapulse',
    type: 'website',
    url: '/predictions/odds-lot',
    images: [
      {
  ...
  twitter: {
    ...
    title: 'odds-lot Football Predictions and Tips - sokapulse',
    description: 'Get the latest odds-lot football predictions and tips for today\'s matches.',
    site: '@sokapulse'
  },
  alternates: {
    canonical: 'https://sokapulse.com/predictions/odds-lot'
  },
  other: {
    'article:publisher': [
...
export default function OddsLotLayout({ children }) {
  return <>{children}</>;
}