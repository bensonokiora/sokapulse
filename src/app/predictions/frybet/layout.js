export const metadata = {
  title: 'frybet Football Predictions and Tips - sokapulse',
  ...
  keywords: 'frybet predictions, football tips, betting tips, football predictions, frybet football',
  openGraph: {
    title: 'frybet Football Predictions and Tips - sokapulse',
    type: 'website',
    url: '/predictions/frybet',
    images: [
      {
  ...
  twitter: {
    ...
    title: 'frybet Football Predictions and Tips - sokapulse',
    description: 'Get the latest frybet football predictions and tips for today\'s matches.',
    site: '@sokapulse'
  },
  alternates: {
    canonical: 'https://sokapulse.com/predictions/frybet'
  },
  other: {
    'article:publisher': [
...
export default function FrybetLayout({ children }) {
  return <>{children}</>;
}