export const metadata = {
  title: '1xBet Toto Football Jackpot Prediction',
  description: 'Readable, practical 1xBet Toto Football jackpot prediction picks with confidence levels and timely updates.',
  alternates: {
    canonical: 'https://sokapulse.com/predictions/1xbet-toto-football-jackpot-predictions'
  },
  openGraph: {
    title: '1xBet Toto Football Jackpot Prediction',
    description: 'Readable, practical 1xBet Toto Football jackpot prediction picks with confidence levels and timely updates.',
    url: 'https://sokapulse.com/predictions/1xbet-toto-football-jackpot-predictions',
    siteName: 'SokaPulse',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: '1xBet Toto Football Jackpot Prediction'
      }
    ],
    locale: 'en_US',
    type: 'website',
  ...
  keywords: ['1xBet Toto Football jackpot prediction', '1xBet Toto Football predictions', 'football predictions', 'jackpot betting', 'SokaPulse'],
  colorScheme: 'light',
  viewport: {
    width: 'device-width',
    initialScale: 1,
  ...
  appleWebApp: {
    ...
    title: '1xBet Toto Football Jackpot Prediction - SokaPulse',
  },
  other: {
    'apple-mobile-web-app-capable': 'yes',
    'apple-mobile-web-app-status-bar-style': 'default',
    'apple-mobile-web-app-title': '1xBet Toto Football Jackpot Prediction - SokaPulse',
    'format-detection': 'telephone=no',
    'mobile-web-app-capable': 'yes',
    'application-name': '1xBet Toto Football Jackpot Prediction - SokaPulse',
  },
  datePublished: '2025-07-28T18:54:21+00:00',
  dateModified: new Date().toISOString(),
};

export default function OneXBetTotoFootballJackpotPredictionLayout({ children }) {
  return <>{children}</>;
} 