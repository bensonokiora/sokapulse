export const metadata = {
  title: 'stats24 Football Predictions and Tips - sokapulse',
  ...
  keywords: 'stats24 predictions, football tips, betting tips, football predictions, stats24 football',
  openGraph: {
    title: 'stats24 Football Predictions and Tips - sokapulse',
    type: 'website',
    url: '/predictions/stats24',
    images: [
      {
  ...
  twitter: {
    ...
    title: 'stats24 Football Predictions and Tips - sokapulse',
    description: 'Get the latest stats24 football predictions and tips for today\'s matches.',
    site: '@sokapulse'
  },
  alternates: {
    canonical: 'https://sokapulse.com/predictions/stats24'
  },
  other: {
    'article:publisher': [
...
export default function Stats24Layout({ children }) {
  return <>{children}</>;
}