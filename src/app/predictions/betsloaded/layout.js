export const metadata = {
  title: 'betsloaded Football Predictions and Tips - sokapulse',
  ...
  keywords: 'betsloaded predictions, football tips, betting tips, football predictions, betsloaded football',
  openGraph: {
    title: 'betsloaded Football Predictions and Tips - sokapulse',
    type: 'website',
    url: '/predictions/betsloaded',
    images: [
      {
  ...
  twitter: {
    ...
    title: 'betsloaded Football Predictions and Tips - sokapulse',
    description: 'Get the latest betsloaded football predictions and tips for today\'s matches.',
    site: '@sokapulse'
  },
  alternates: {
    canonical: 'https://sokapulse.com/predictions/betsloaded'
  },
  other: {
    'article:publisher': [
...
export default function BetsloadedLayout({ children }) {
  return <>{children}</>;
}