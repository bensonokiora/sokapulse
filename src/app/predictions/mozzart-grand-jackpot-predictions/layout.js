export const metadata = {
  title: 'Mozzart Grand Jackpot Prediction',
  description: 'Get Sure Mozzart Grand Jackpot Prediction daily & increase your chances of winning the Mozzart Grand Jackpot',
  alternates: {
    canonical: 'https://sokapulse.com/predictions/mozzart-grand-jackpot-predictions'
  },
  openGraph: {
    title: 'Mozzart Grand Jackpot Prediction',
    description: 'Get Sure Mozzart Grand Jackpot Prediction daily & increase your chances of winning the Mozzart Grand Jackpot',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Mozzart Grand Jackpot Prediction'
      }
    ],
    locale: 'en_US',
    type: 'website',
  ...
  keywords: ['Mozzart Grand Jackpot Predictions', 'football predictions', 'betting tips', 'sports analysis', 'jackpot betting', 'SokaPulse'],
  authors: [{ name: 'SokaPulse' }],
  colorScheme: 'light',
  viewport: {
    width: 'device-width',
  ...
  appleWebApp: {
    ...
    title: 'Mozzart Grand Jackpot Prediction - SokaPulse',
  },
  other: {
    'apple-mobile-web-app-capable': 'yes',
    'apple-mobile-web-app-status-bar-style': 'default',
    'apple-mobile-web-app-title': 'Mozzart Grand Jackpot Prediction - SokaPulse',
    'format-detection': 'telephone=no',
    'mobile-web-app-capable': 'yes',
    'application-name': 'Mozzart Grand Jackpot Prediction - SokaPulse',
  },
  datePublished: '2025-07-28T18:54:21+00:00',
  dateModified: new Date().toISOString(),
};

export default function MozzartGrandJackpotPredictionLayout({ children }) {
  return <>{children}</>;
} 