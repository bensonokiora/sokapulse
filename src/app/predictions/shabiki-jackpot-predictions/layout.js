export const metadata = {
  title: 'Shabiki Jackpot Prediction',
  description: 'Shabiki jackpot prediction picks with practical analysis, confidence levels, and fast updates to help you bet smarter.',
  alternates: {
    canonical: 'https://sokapulse.com/predictions/shabiki-jackpot-predictions'
  },
  openGraph: {
    title: 'Shabiki Jackpot Prediction',
    description: 'Shabiki jackpot prediction picks with practical analysis, confidence levels, and fast updates to help you bet smarter.',
    url: 'https://sokapulse.com/predictions/shabiki-jackpot-predictions',
    siteName: 'SokaPulse',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Shabiki Jackpot Prediction'
      }
    ],
    locale: 'en_US',
    type: 'website',
  ...
  keywords: ['Shabiki jackpot prediction', 'Shabiki jackpot predictions', 'football predictions', 'jackpot betting', 'SokaPulse'],
  colorScheme: 'light',
  viewport: {
    width: 'device-width',
    initialScale: 1,
  ...
  appleWebApp: {
    ...
    title: 'Shabiki Jackpot Prediction - SokaPulse',
  },
  other: {
    'apple-mobile-web-app-capable': 'yes',
    'apple-mobile-web-app-status-bar-style': 'default',
    'apple-mobile-web-app-title': 'Shabiki Jackpot Prediction - SokaPulse',
    'format-detection': 'telephone=no',
    'mobile-web-app-capable': 'yes',
    'application-name': 'Shabiki Jackpot Prediction - SokaPulse',
  },
  datePublished: '2025-07-28T18:54:21+00:00',
  dateModified: new Date().toISOString(),
};

export default function ShabikiJackpotPredictionLayout({ children }) {
  return <>{children}</>;
} 