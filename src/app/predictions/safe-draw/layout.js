export const metadata = {
  title: 'safe-draw Football Predictions and Tips - sokapulse',
  ...
  keywords: 'safe-draw predictions, football tips, betting tips, football predictions, safe-draw football',
  openGraph: {
    title: 'safe-draw Football Predictions and Tips - sokapulse',
    type: 'website',
    url: '/predictions/safe-draw',
    images: [
      {
  ...
  twitter: {
    ...
    title: 'safe-draw Football Predictions and Tips - sokapulse',
    description: 'Get the latest safe-draw football predictions and tips for today\'s matches.',
    site: '@sokapulse'
  },
  alternates: {
    canonical: 'https://sokapulse.com/predictions/safe-draw'
  },
  other: {
    'article:publisher': [
...
export default function SafeDrawLayout({ children }) {
  return <>{children}</>;
}