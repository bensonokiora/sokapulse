export const metadata = {
  title: 'sure-bet Football Predictions and Tips - sokapulse',
  ...
  keywords: 'sure-bet predictions, football tips, betting tips, football predictions, sure-bet football',
  openGraph: {
    title: 'sure-bet Football Predictions and Tips - sokapulse',
    type: 'website',
    url: '/predictions/sure-bet',
    images: [
      {
  ...
  twitter: {
    ...
    title: 'sure-bet Football Predictions and Tips - sokapulse',
    description: 'Get the latest sure-bet football predictions and tips for today\'s matches.',
    site: '@sokapulse'
  },
  alternates: {
    canonical: 'https://sokapulse.com/predictions/sure-bet'
  },
  other: {
    'article:publisher': [
...
export default function SureBetLayout({ children }) {
  return <>{children}</>;
}