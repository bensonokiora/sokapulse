export const metadata = {
  title: 'Dafabet Jackpot Prediction',
  description: 'Get Sure Dafabet Jackpot Prediction daily & increase your chances of winning the Dafabet Jackpot',
  alternates: {
    canonical: 'https://sokapulse.com/predictions/dafabet-jackpot-predictions'
  },
  openGraph: {
    title: 'Dafabet Jackpot Prediction',
    description: 'Get Sure Dafabet Jackpot Prediction daily & increase your chances of winning the Dafabet Jackpot',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Dafabet Jackpot Prediction'
      }
    ],
    locale: 'en_US',
    type: 'website',
  ...
  keywords: ['Dafabet Jackpot Predictions', 'football predictions', 'betting tips', 'sports analysis', 'jackpot betting', 'SokaPulse'],
  authors: [{ name: 'SokaPulse' }],
  colorScheme: 'light',
  viewport: {
    width: 'device-width',
  ...
  appleWebApp: {
    ...
    title: 'Dafabet Jackpot Prediction - SokaPulse',
  },
  other: {
    'apple-mobile-web-app-capable': 'yes',
    'apple-mobile-web-app-status-bar-style': 'default',
    'apple-mobile-web-app-title': 'Dafabet Jackpot Prediction - SokaPulse',
    'format-detection': 'telephone=no',
    'mobile-web-app-capable': 'yes',
    'application-name': 'Dafabet Jackpot Prediction - SokaPulse',
  },
  datePublished: '2025-07-28T18:54:21+00:00',
  dateModified: new Date().toISOString(),
};

export default function DafabetJackpotPredictionLayout({ children }) {
  return <>{children}</>;
} 