...
export async function generateMetadata() {
  return {
    title: sportpesaMegaJackpotContent.title,
    description: sportpesaMegaJackpotContent.description,
    keywords: sportpesaMegaJackpotContent.keywords,
    other: {
      'script[type="application/ld+json"]': JSON.stringify(sportpesaMegaJackpotContent.schema),
    }
  };
}

export default async function SportpesaMegaJackpotPredictionPage() {
    ...
    <div className="jp-container">
      <Suspense fallback={
        <div className="jp-loading-container flex justify-center items-center h-64">
          <p className="jp-loading-text text-lg">Loading Mega Jackpot Details...</p>
        </div>
      }>
        <SportpesaMegaJackpotDisplay 
          ...
          serverError={error}
          seoContent={sportpesaMegaJackpotContent}
