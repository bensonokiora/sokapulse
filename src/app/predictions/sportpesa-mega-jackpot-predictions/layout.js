export const metadata = {
  title: 'Sportpesa Mega Jackpot Prediction - 17 Games this Weekend',
  ...
  alternates: {
    canonical: 'https://sokapulse.com/predictions/sportpesa-mega-jackpot-predictions'
  },
  openGraph: {
    title: 'Sportpesa Mega Jackpot Prediction - 17 Games this Weekend',
    description: 'Get Sure Mega Jackpot Prediction this Weekend & increase your chances of winning the Sportpesa Mega Jackpot - 17 games & bonuses this weekend',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Sportpesa Mega Jackpot Predictions'
      }
    ],
    locale: 'en_US',
    type: 'website',
  ...
  keywords: ['Sportpesa Mega Jackpot Predictions', 'football predictions', 'betting tips', 'sports analysis', 'jackpot betting', 'SokaPulse'],
  authors: [{ name: 'SokaPulse' }],
  colorScheme: 'light',
  viewport: {
    width: 'device-width',
  ...
  appleWebApp: {
    ...
    title: 'Sportpesa Mega Jackpot Predictions - SokaPulse',
  },
  other: {
    'apple-mobile-web-app-capable': 'yes',
    'apple-mobile-web-app-status-bar-style': 'default',
    'apple-mobile-web-app-title': 'Sportpesa Mega Jackpot Predictions - SokaPulse',
    'format-detection': 'telephone=no',
    'mobile-web-app-capable': 'yes',
    'application-name': 'Sportpesa Mega Jackpot Predictions - SokaPulse',
  },
  datePublished: '2025-03-20T18:54:21+00:00',
  dateModified: new Date().toISOString(),
};

export default function SportpesaMegaJackpotPredictionLayout({ children }) {
  return <>{children}</>;
} 