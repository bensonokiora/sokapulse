export const metadata = {
  title: 'fulltime-predict Football Predictions and Tips - sokapulse',
  ...
  keywords: 'fulltime-predict predictions, football tips, betting tips, football predictions, fulltime-predict football',
  openGraph: {
    title: 'fulltime-predict Football Predictions and Tips - sokapulse',
    type: 'website',
    url: '/predictions/fulltime-predict',
    images: [
      {
  ...
  twitter: {
    ...
    title: 'fulltime-predict Football Predictions and Tips - sokapulse',
    description: 'Get the latest fulltime-predict football predictions and tips for today\'s matches.',
    site: '@sokapulse'
  },
  alternates: {
    canonical: 'https://sokapulse.com/predictions/fulltime-predict'
  },
  other: {
    'article:publisher': [
...
export default function FulltimePredictLayout({ children }) {
  return <>{children}</>;
}