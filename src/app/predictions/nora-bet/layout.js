export const metadata = {
  title: 'nora-bet Football Predictions and Tips - sokapulse',
  ...
  keywords: 'nora-bet predictions, football tips, betting tips, football predictions, nora-bet football',
  openGraph: {
    title: 'nora-bet Football Predictions and Tips - sokapulse',
    type: 'website',
    url: '/predictions/nora-bet',
    images: [
      {
  ...
  twitter: {
    ...
    title: 'nora-bet Football Predictions and Tips - sokapulse',
    description: 'Get the latest nora-bet football predictions and tips for today\'s matches.',
    site: '@sokapulse'
  },
  alternates: {
    canonical: 'https://sokapulse.com/predictions/nora-bet'
  },
  other: {
    'article:publisher': [
...
export default function NoraBetLayout({ children }) {
  return <>{children}</>;
}