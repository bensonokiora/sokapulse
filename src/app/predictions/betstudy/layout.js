export const metadata = {
  title: 'betstudy Football Predictions and Tips - sokapulse',
  ...
  keywords: 'betstudy predictions, football tips, betting tips, football predictions, betstudy football',
  openGraph: {
    title: 'betstudy Football Predictions and Tips - sokapulse',
    type: 'website',
    url: '/predictions/betstudy',
    images: [
      {
  ...
  twitter: {
    ...
    title: 'betstudy Football Predictions and Tips - sokapulse',
    description: 'Get the latest betstudy football predictions and tips for today\'s matches.',
    site: '@sokapulse'
  },
  alternates: {
    canonical: 'https://sokapulse.com/predictions/betstudy'
  },
  other: {
    'article:publisher': [
...
export default function BetstudyLayout({ children }) {
  return <>{children}</>;
}