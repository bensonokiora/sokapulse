export const metadata = {
  title: 'stakegains Football Predictions and Tips - sokapulse',
  ...
  keywords: 'stakegains predictions, football tips, betting tips, football predictions, stakegains football',
  openGraph: {
    title: 'stakegains Football Predictions and Tips - sokapulse',
    type: 'website',
    url: '/predictions/stakegains',
    images: [
      {
  ...
  twitter: {
    ...
    title: 'stakegains Football Predictions and Tips - sokapulse',
    description: 'Get the latest stakegains football predictions and tips for today\'s matches.',
    site: '@sokapulse'
  },
  alternates: {
    canonical: 'https://sokapulse.com/predictions/stakegains'
  },
  other: {
    'article:publisher': [
...
export default function StakegainsLayout({ children }) {
  return <>{children}</>;
}