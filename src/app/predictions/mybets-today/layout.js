export const metadata = {
  title: 'mybets-today Football Predictions and Tips - sokapulse',
  ...
  keywords: 'mybets-today predictions, football tips, betting tips, football predictions, mybets-today football',
  openGraph: {
    title: 'mybets-today Football Predictions and Tips - sokapulse',
    type: 'website',
    url: '/predictions/mybets-today',
    images: [
      {
  ...
  twitter: {
    ...
    title: 'mybets-today Football Predictions and Tips - sokapulse',
    description: 'Get the latest mybets-today football predictions and tips for today\'s matches.',
    site: '@sokapulse'
  },
  alternates: {
    canonical: 'https://sokapulse.com/predictions/mybets-today'
  },
  other: {
    'article:publisher': [
...
export default function MybetsTodayLayout({ children }) {
  return <>{children}</>;
}