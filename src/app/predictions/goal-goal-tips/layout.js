export const metadata = {
  title: 'goal-goal-tips Football Predictions and Tips - sokapulse',
  ...
  keywords: 'goal-goal-tips predictions, football tips, betting tips, football predictions, goal-goal-tips football',
  openGraph: {
    title: 'goal-goal-tips Football Predictions and Tips - sokapulse',
    type: 'website',
    url: '/predictions/goal-goal-tips',
    images: [
      {
  ...
  twitter: {
    ...
    title: 'goal-goal-tips Football Predictions and Tips - sokapulse',
    description: 'Get the latest goal-goal-tips football predictions and tips for today\'s matches.',
    site: '@sokapulse'
  },
  alternates: {
    canonical: 'https://sokapulse.com/predictions/goal-goal-tips'
  },
  other: {
    'article:publisher': [
...
export default function GoalGoalTipsLayout({ children }) {
  return <>{children}</>;
}