export const metadata = {
  title: 'sportverified Football Predictions and Tips - sokapulse',
  ...
  keywords: 'sportverified predictions, football tips, betting tips, football predictions, sportverified football',
  openGraph: {
    title: 'sportverified Football Predictions and Tips - sokapulse',
    type: 'website',
    url: '/predictions/sportverified',
    images: [
      {
  ...
  twitter: {
    ...
    title: 'sportverified Football Predictions and Tips - sokapulse',
    description: 'Get the latest sportverified football predictions and tips for today\'s matches.',
    site: '@sokapulse'
  },
  alternates: {
    canonical: 'https://sokapulse.com/predictions/sportverified'
  },
  other: {
    'article:publisher': [
...
export default function SportverifiedLayout({ children }) {
  return <>{children}</>;
}