export const metadata = {
  title: 'football-whispers Football Predictions and Tips - sokapulse',
  ...
  keywords: 'football-whispers predictions, football tips, betting tips, football predictions, football-whispers football',
  openGraph: {
    title: 'football-whispers Football Predictions and Tips - sokapulse',
    type: 'website',
    url: '/predictions/football-whispers',
    images: [
      {
  ...
  twitter: {
    ...
    title: 'football-whispers Football Predictions and Tips - sokapulse',
    description: 'Get the latest football-whispers football predictions and tips for today\'s matches.',
    site: '@sokapulse'
  },
  alternates: {
    canonical: 'https://sokapulse.com/predictions/football-whispers'
  },
  other: {
    'article:publisher': [
...
export default function FootballWhispersLayout({ children }) {
  return <>{children}</>;
}