export const metadata = {
  title: 'windrawwin Football Predictions and Tips - sokapulse',
  ...
  keywords: 'windrawwin predictions, football tips, betting tips, football predictions, windrawwin football',
  openGraph: {
    title: 'windrawwin Football Predictions and Tips - sokapulse',
    type: 'website',
    url: '/predictions/windrawwin',
    images: [
      {
  ...
  twitter: {
    ...
    title: 'windrawwin Football Predictions and Tips - sokapulse',
    description: 'Get the latest windrawwin football predictions and tips for today\'s matches.',
    site: '@sokapulse'
  },
  alternates: {
    canonical: 'https://sokapulse.com/predictions/windrawwin'
  },
  other: {
    'article:publisher': [
...
export default function WindrawwinLayout ({ children }) {
  return <>{children}</>;
}