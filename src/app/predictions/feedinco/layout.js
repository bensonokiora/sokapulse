export const metadata = {
  title: 'feedinco Football Predictions and Tips - sokapulse',
  ...
  keywords: 'feedinco predictions, football tips, betting tips, football predictions, feedinco football',
  openGraph: {
    title: 'feedinco Football Predictions and Tips - sokapulse',
    type: 'website',
    url: '/predictions/feedinco',
    images: [
      {
  ...
  twitter: {
    ...
    title: 'feedinco Football Predictions and Tips - sokapulse',
    description: 'Get the latest feedinco football predictions and tips for today\'s matches.',
    site: '@sokapulse'
  },
  alternates: {
    canonical: 'https://sokapulse.com/predictions/feedinco'
  },
  other: {
    'article:publisher': [
...
export default function FeedincoLayout({ children }) {
  return <>{children}</>;
}