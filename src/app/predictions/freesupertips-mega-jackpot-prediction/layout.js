export const metadata = {
  title: 'Freesupertips Mega Jackpot Predictions & Analysis - SokaPulse',
  description: 'Human-written Freesupertips Mega Jackpot Prediction with clear reasoning, value angles, and pre-kickoff updates.',
  alternates: {
    canonical: 'https://sokapulse.com/predictions/freesupertips-mega-jackpot-prediction'
  },
  openGraph: {
    title: 'Freesupertips Mega Jackpot Predictions & Analysis - SokaPulse',
    description: 'Human-written Freesupertips Mega Jackpot Prediction with clear reasoning, value angles, and pre-kickoff updates.',
    ...
    siteName: 'SokaPulse',
    images: [
      { url: 'https://sokapulse.com/images/og-image.jpg', width: 1200, height: 630, alt: 'Freesupertips Mega Jackpot Predictions' }
    ],
    locale: 'en_US',
    type: 'website',
  },
  twitter: {
    ...
    title: 'Freesupertips Mega Jackpot Predictions & Analysis - SokaPulse',
    description: 'Human-written Freesupertips Mega Jackpot Prediction with clear logic and updates.',
  ...
  keywords: ['Freesupertips Mega Jackpot Prediction', 'mega jackpot predictions', 'football predictions', 'betting tips', 'jackpot betting', 'SokaPulse'],
  colorScheme: 'light',
  ...
  icons: {
    ...
    other: [ { rel: 'icon', url: '/assets/images/android-icon-192x192.png', sizes: '192x192', type: 'image/png' } ],
  },
  manifest: '/assets/images/manifest.json',
  appleWebApp: { capable: true, statusBarStyle: 'default', title: 'Freesupertips Mega Jackpot Predictions - SokaPulse' },
  other: {
    'apple-mobile-web-app-capable': 'yes',
    'apple-mobile-web-app-status-bar-style': 'default',
    'apple-mobile-web-app-title': 'Freesupertips Mega Jackpot Predictions - SokaPulse',
    'format-detection': 'telephone=no',
    'mobile-web-app-capable': 'yes',
    'application-name': 'Freesupertips Mega Jackpot Predictions - SokaPulse',
  },
  datePublished: '2025-03-20T18:54:21+00:00',
  dateModified: new Date().toISOString(),
};

export default function FreesupertipsMegaJackpotPredictionLayout({ children }) { return <>{children}</>; } 