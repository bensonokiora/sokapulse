export const metadata = {
  title: 'winabettips Football Predictions and Tips - sokapulse',
  ...
  keywords: 'winabettips predictions, football tips, betting tips, football predictions, winabettips football',
  openGraph: {
    title: 'winabettips Football Predictions and Tips - sokapulse',
    type: 'website',
    url: '/predictions/winabettips',
    images: [
      {
  ...
  twitter: {
    ...
    title: 'winabettips Football Predictions and Tips - sokapulse',
    description: 'Get the latest winabettips football predictions and tips for today\'s matches.',
    site: '@sokapulse'
  },
  alternates: {
    canonical: 'https://sokapulse.com/predictions/winabettips'
  },
  other: {
    'article:publisher': [
...
export default function WinabettipsLayout({ children }) {
  return <>{children}</>;
}