export const metadata = {
  title: 'Correct Score Mega Jackpot Predictions - 17 Games Weekly Analysis',
  description:
    'Correct Score Mega Jackpot predictions with probability‑led scoreline shortlists and clear risk notes for all 17 games.',
  alternates: {
    canonical: 'https://sokapulse.com/predictions/correct-score-mega-jackpot-predictions'
  },
  openGraph: {
    title: 'Correct Score Mega Jackpot Predictions - 17 Games Weekly Analysis',
    description:
      'Correct Score Mega Jackpot predictions with probability‑led scoreline shortlists and clear risk notes for all 17 games.',
    url: 'https://sokapulse.com/predictions/correct-score-mega-jackpot-predictions',
    siteName: 'SokaPulse',
    images: [
      { url: 'https://sokapulse.com/images/og-image.jpg', width: 1200, height: 630, alt: 'Correct Score Mega Jackpot Predictions' }
    ],
    locale: 'en_US',
    type: 'website',
  },
  ...
  keywords: [
    'Correct Score Mega Jackpot Predictions',
  ...
  appleWebApp: { capable: true, statusBarStyle: 'default', title: 'Correct Score Mega Jackpot Predictions - SokaPulse' },
  other: {
    'apple-mobile-web-app-capable': 'yes',
    'apple-mobile-web-app-status-bar-style': 'default',
    'apple-mobile-web-app-title': 'Correct Score Mega Jackpot Predictions - SokaPulse',
    'format-detection': 'telephone=no',
    'mobile-web-app-capable': 'yes',
    'application-name': 'Correct Score Mega Jackpot Predictions - SokaPulse',
  },
  datePublished: '2025-03-20T18:54:21+00:00',
  dateModified: new Date().toISOString(),
};

export default function CorrectScoreMegaJackpotPredictionLayout({ children }) {
  return <>{children}</>;
} 