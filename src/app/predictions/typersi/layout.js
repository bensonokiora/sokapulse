export const metadata = {
  title: 'typersi Football Predictions and Tips - sokapulse',
  ...
  keywords: 'typersi predictions, football tips, betting tips, football predictions, typersi football',
  openGraph: {
    title: 'typersi Football Predictions and Tips - sokapulse',
    type: 'website',
    url: '/predictions/typersi',
    images: [
      {
  ...
  twitter: {
    ...
    title: 'typersi Football Predictions and Tips - sokapulse',
    description: 'Get the latest typersi football predictions and tips for today\'s matches.',
    site: '@sokapulse'
  },
  alternates: {
    canonical: 'https://sokapulse.com/predictions/typersi'
  },
  other: {
    'article:publisher': [
...
export default function TypersiLayout({ children }) {
  return <>{children}</>;
}