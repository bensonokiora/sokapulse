export const metadata = {
  title: 'SoccerVista Mega Jackpot Predictions & Analysis - SokaPulse',
  description: 'Fresh, human-written SoccerVista Mega Jackpot Prediction content with data-backed insights and clear reasoning. Updated ahead of kickoff.',
  alternates: {
    canonical: 'https://sokapulse.com/predictions/soccervista-mega-jackpot-prediction'
  },
  openGraph: {
    title: 'SoccerVista Mega Jackpot Predictions & Analysis - SokaPulse',
    description: 'Fresh, human-written SoccerVista Mega Jackpot Prediction content with data-backed insights and clear reasoning. Updated ahead of kickoff.',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'SoccerVista Mega Jackpot Predictions'
      }
    ],
    locale: 'en_US',
    type: 'website',
  ...
  twitter: {
    ...
    title: 'SoccerVista Mega Jackpot Predictions & Analysis - SokaPulse',
    description: 'Human-written SoccerVista Mega Jackpot Prediction with expert guidance and clear logic.',
  ...
  keywords: ['SoccerVista Mega Jackpot Prediction', 'mega jackpot predictions', 'football predictions', 'betting tips', 'jackpot betting', 'SokaPulse'],
  colorScheme: 'light',
  viewport: {
    width: 'device-width',
    initialScale: 1,
  ...
  appleWebApp: {
    ...
    title: 'SoccerVista Mega Jackpot Predictions - SokaPulse',
  },
  other: {
    'apple-mobile-web-app-capable': 'yes',
    'apple-mobile-web-app-status-bar-style': 'default',
    'apple-mobile-web-app-title': 'SoccerVista Mega Jackpot Predictions - SokaPulse',
    'format-detection': 'telephone=no',
    'mobile-web-app-capable': 'yes',
    'application-name': 'SoccerVista Mega Jackpot Predictions - SokaPulse',
  },
  datePublished: '2025-03-20T18:54:21+00:00',
  dateModified: new Date().toISOString(),
};

export default function SoccerVistaMegaJackpotPredictionLayout({ children }) {
  return <>{children}</>;
} 