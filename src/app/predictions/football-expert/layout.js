export const metadata = {
  title: 'football-expert Football Predictions and Tips - sokapulse',
  ...
  keywords: 'football-expert predictions, football tips, betting tips, football predictions, football-expert football',
  openGraph: {
    title: 'football-expert Football Predictions and Tips - sokapulse',
    type: 'website',
    url: '/predictions/football-expert',
    images: [
      {
  ...
  twitter: {
    ...
    title: 'football-expert Football Predictions and Tips - sokapulse',
    description: 'Get the latest football-expert football predictions and tips for today\'s matches.',
    site: '@sokapulse'
  },
  alternates: {
    canonical: 'https://sokapulse.com/predictions/football-expert'
  },
  other: {
    'article:publisher': [
...
export default function FootballExpertLayout({ children }) {
  return <>{children}</>;
}