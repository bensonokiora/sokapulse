export const metadata = {
  title: 'topbetpredict Football Predictions and Tips - sokapulse',
  ...
  keywords: 'topbetpredict predictions, football tips, betting tips, football predictions, topbetpredict football',
  openGraph: {
    title: 'topbetpredict Football Predictions and Tips - sokapulse',
    type: 'website',
    url: '/predictions/topbetpredict',
    images: [
      {
  ...
  twitter: {
    ...
    title: 'topbetpredict Football Predictions and Tips - sokapulse',
    description: 'Get the latest topbetpredict football predictions and tips for today\'s matches.',
    site: '@sokapulse'
  },
  alternates: {
    canonical: 'https://sokapulse.com/predictions/topbetpredict'
  },
  other: {
    'article:publisher': [
...
export default function TopbetpredictLayout({ children }) {
  return <>{children}</>;
}