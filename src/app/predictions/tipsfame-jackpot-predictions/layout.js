export const metadata = {
  title: 'Tipsfame Jackpot Predictions - 17 Games Weekly Analysis',
  description:
    'Accurate Tipsfame Jackpot Predictions with transparent reasoning. Human‑written, data‑assisted picks for all 17 games updated weekly.',
  alternates: {
    canonical: 'https://sokapulse.com/predictions/tipsfame-jackpot-predictions'
  },
  openGraph: {
    title: 'Tipsfame Jackpot Predictions - 17 Games Weekly Analysis',
    description:
      'Accurate Tipsfame Jackpot Predictions with transparent reasoning. Human‑written, data‑assisted picks for all 17 games updated weekly.',
    url: 'https://sokapulse.com/predictions/tipsfame-jackpot-predictions',
    siteName: 'SokaPulse',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Tipsfame Jackpot Predictions'
      }
    ],
    locale: 'en_US',
    type: 'website',
  ...
  appleWebApp: {
    ...
    title: 'Tipsfame Jackpot Predictions - SokaPulse',
  },
  other: {
    'apple-mobile-web-app-capable': 'yes',
    'apple-mobile-web-app-status-bar-style': 'default',
    'apple-mobile-web-app-title': 'Tipsfame Jackpot Predictions - SokaPulse',
    'format-detection': 'telephone=no',
    'mobile-web-app-capable': 'yes',
    'application-name': 'Tipsfame Jackpot Predictions - SokaPulse',
  },
  datePublished: '2025-03-20T18:54:21+00:00',
  dateModified: new Date().toISOString(),
};

export default function TipsfameJackpotPredictionLayout({ children }) {
  return <>{children}</>;
} 