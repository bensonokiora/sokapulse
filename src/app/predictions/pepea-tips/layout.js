export const metadata = {
  title: 'pepea-tips Football Predictions and Tips - sokapulse',
  ...
  keywords: 'pepea-tips predictions, football tips, betting tips, football predictions, pepea-tips football',
  openGraph: {
    title: 'pepea-tips Football Predictions and Tips - sokapulse',
    type: 'website',
    url: '/predictions/pepea-tips',
    images: [
      {
  ...
  twitter: {
    ...
    title: 'pepea-tips Football Predictions and Tips - sokapulse',
    description: 'Get the latest pepea-tips football predictions and tips for today\'s matches.',
    site: '@sokapulse'
  },
  alternates: {
    canonical: 'https://sokapulse.com/predictions/pepea-tips'
  },
  other: {
    'article:publisher': [
