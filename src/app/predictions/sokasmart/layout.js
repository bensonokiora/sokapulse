export const metadata = {
  title: 'sokasmart Football Predictions and Tips - sokapulse',
  ...
  keywords: 'sokasmart predictions, football tips, betting tips, football predictions, sokasmart football',
  openGraph: {
    title: 'sokasmart Football Predictions and Tips - sokapulse',
    type: 'website',
    url: '/predictions/sokasmart',
    images: [
      {
  ...
  twitter: {
    ...
    title: 'sokasmart Football Predictions and Tips - sokapulse',
    description: 'Get the latest sokasmart football predictions and tips for today\'s matches.',
    site: '@sokapulse'
  },
  alternates: {
    canonical: 'https://sokapulse.com/predictions/sokasmart'
  },
  other: {
    'article:publisher': [
...
export default function SokasmartLayout({ children }) {
  return <>{children}</>;
}