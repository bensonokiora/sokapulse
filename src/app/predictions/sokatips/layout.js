export const metadata = {
  title: 'sokatips Football Predictions and Tips - sokapulse',
  ...
  keywords: 'sokatips predictions, football tips, betting tips, football predictions, sokatips football',
  openGraph: {
    title: 'sokatips Football Predictions and Tips - sokapulse',
    type: 'website',
    url: '/predictions/sokatips',
    images: [
      {
  ...
  twitter: {
    ...
    title: 'sokatips Football Predictions and Tips - sokapulse',
    description: 'Get the latest sokatips football predictions and tips for today\'s matches.',
    site: '@sokapulse'
  },
  alternates: {
    canonical: 'https://sokapulse.com/predictions/sokatips'
  },
  other: {
    'article:publisher': [
...
export default function SokatipsLayout({ children }) {
  return <>{children}</>;
}