export const metadata = {
  title: 'r2bet Football Predictions and Tips - sokapulse',
  ...
  keywords: 'r2bet predictions, football tips, betting tips, football predictions, r2bet football',
  openGraph: {
    title: 'r2bet Football Predictions and Tips - sokapulse',
    type: 'website',
    url: '/predictions/r2bet',
    images: [
      {
  ...
  twitter: {
    ...
    title: 'r2bet Football Predictions and Tips - sokapulse',
    description: 'Get the latest r2bet football predictions and tips for today\'s matches.',
    site: '@sokapulse'
  },
  alternates: {
    canonical: 'https://sokapulse.com/predictions/r2bet'
  },
  other: {
    'article:publisher': [
...
export default function R2betLayout({ children }) {
  return <>{children}</>;
}