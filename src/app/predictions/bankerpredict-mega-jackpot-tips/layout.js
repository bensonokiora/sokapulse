export const metadata = {
  title: 'BankerPredict Mega Jackpot Tips - 17 Games Weekly Analysis',
  description:
    'BankerPredict Mega Jackpot tips with confidence tiers and safer pivots to structure a disciplined 17‑game slip.',
  alternates: {
    canonical: 'https://sokapulse.com/predictions/bankerpredict-mega-jackpot-tips'
  },
  openGraph: {
    title: 'BankerPredict Mega Jackpot Tips - 17 Games Weekly Analysis',
    description:
      'BankerPredict Mega Jackpot tips with confidence tiers and safer pivots to structure a disciplined 17‑game slip.',
    url: 'https://sokapulse.com/predictions/bankerpredict-mega-jackpot-tips',
    siteName: 'SokaPulse',
    images: [
      { url: 'https://sokapulse.com/images/og-image.jpg', width: 1200, height: 630, alt: 'BankerPredict Mega Jackpot Tips' }
    ],
    locale: 'en_US',
    type: 'website',
  },
  ...
  keywords: [
    'BankerPredict Mega Jackpot Tips',
  ...
  appleWebApp: { capable: true, statusBarStyle: 'default', title: 'BankerPredict Mega Jackpot Tips - SokaPulse' },
  other: {
    'apple-mobile-web-app-capable': 'yes',
    'apple-mobile-web-app-status-bar-style': 'default',
    'apple-mobile-web-app-title': 'BankerPredict Mega Jackpot Tips - SokaPulse',
    'format-detection': 'telephone=no',
    'mobile-web-app-capable': 'yes',
    'application-name': 'BankerPredict Mega Jackpot Tips - SokaPulse',
  },
  datePublished: '2025-03-20T18:54:21+00:00',
  dateModified: new Date().toISOString(),
};

export default function BankerpredictMegaJackpotTipsLayout({ children }) {
  return <>{children}</>;
} 