export const metadata = {
  title: 'Sportybet Jackpot Prediction',
  description: 'Sportybet jackpot prediction picks with practical analysis, confidence levels, and fast updates to help you bet smarter.',
  alternates: {
    canonical: 'https://sokapulse.com/predictions/sportybet-jackpot-predictions'
  },
  openGraph: {
    title: 'Sportybet Jackpot Prediction',
    description: 'Sportybet jackpot prediction picks with practical analysis, confidence levels, and fast updates to help you bet smarter.',
    url: 'https://sokapulse.com/predictions/sportybet-jackpot-predictions',
    siteName: 'SokaPulse',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Sportybet Jackpot Prediction'
      }
    ],
    locale: 'en_US',
    type: 'website',
  ...
  keywords: ['Sportybet jackpot prediction', 'Sportybet jackpot predictions', 'football predictions', 'jackpot betting', 'SokaPulse'],
  colorScheme: 'light',
  viewport: {
    width: 'device-width',
    initialScale: 1,
  ...
  appleWebApp: {
    ...
    title: 'Sportybet Jackpot Prediction - SokaPulse',
  },
  other: {
    'apple-mobile-web-app-capable': 'yes',
    'apple-mobile-web-app-status-bar-style': 'default',
    'apple-mobile-web-app-title': 'Sportybet Jackpot Prediction - SokaPulse',
    'format-detection': 'telephone=no',
    'mobile-web-app-capable': 'yes',
    'application-name': 'Sportybet Jackpot Prediction - SokaPulse',
  },
  datePublished: '2025-07-28T18:54:21+00:00',
  dateModified: new Date().toISOString(),
};

export default function SportybetJackpotPredictionLayout({ children }) {
  return <>{children}</>;
} 