export const metadata = {
  title: 'sportsmole Football Predictions and Tips - sokapulse',
  ...
  keywords: 'sportsmole predictions, football tips, betting tips, football predictions, sportsmole football',
  openGraph: {
    title: 'sportsmole Football Predictions and Tips - sokapulse',
    type: 'website',
    url: '/predictions/sportsmole',
    images: [
      {
  ...
  twitter: {
    ...
    title: 'sportsmole Football Predictions and Tips - sokapulse',
    description: 'Get the latest sportsmole football predictions and tips for today\'s matches.',
    site: '@sokapulse'
  },
  alternates: {
    canonical: 'https://sokapulse.com/predictions/sportsmole'
  },
  other: {
    'article:publisher': [
...
export default function SportsmoleLayout({ children }) {
  return <>{children}</>;
}