export const metadata = {
  title: 'clevertips Football Predictions and Tips - sokapulse',
  ...
  keywords: 'clevertips predictions, football tips, betting tips, football predictions, clevertips football',
  openGraph: {
    title: 'clevertips Football Predictions and Tips - sokapulse',
    type: 'website',
    url: '/predictions/clevertips',
    images: [
      {
  ...
  twitter: {
    ...
    title: 'clevertips Football Predictions and Tips - sokapulse',
    description: 'Get the latest clevertips football predictions and tips for today\'s matches.',
    site: '@sokapulse'
  },
  alternates: {
    canonical: 'https://sokapulse.com/predictions/clevertips'
  },
  other: {
    'article:publisher': [
...
export default function ClevertipsLayout({ children }) {
  return <>{children}</>;
}