export const metadata = {
  title: 'MSport Jackpot Prediction',
  description: 'MSport jackpot prediction picks with practical analysis, confidence levels, and fast updates to help you bet smarter.',
  alternates: {
    canonical: 'https://sokapulse.com/predictions/msport-jackpot-predictions'
  },
  openGraph: {
    title: 'MSport Jackpot Prediction',
    description: 'MSport jackpot prediction picks with practical analysis, confidence levels, and fast updates to help you bet smarter.',
    url: 'https://sokapulse.com/predictions/msport-jackpot-predictions',
    siteName: 'SokaPulse',
    images: [
      {
  ...
  keywords: ['MSport jackpot prediction', 'MSport jackpot predictions', 'football predictions', 'jackpot betting', 'SokaPulse'],
  colorScheme: 'light',
  viewport: {
    width: 'device-width',
    initialScale: 1,
  ...
  appleWebApp: {
    ...
    title: 'MSport Jackpot Prediction - SokaPulse',
  },
  other: {
    'apple-mobile-web-app-capable': 'yes',
    'apple-mobile-web-app-status-bar-style': 'default',
    'apple-mobile-web-app-title': 'MSport Jackpot Prediction - SokaPulse',
    'format-detection': 'telephone=no',
    'mobile-web-app-capable': 'yes',
    'application-name': 'MSport Jackpot Prediction - SokaPulse',
  },
  datePublished: '2025-07-28T18:54:21+00:00',
  dateModified: new Date().toISOString(),
};

export default function MSportJackpotPredictionLayout({ children }) {
  return <>{children}</>;
} 