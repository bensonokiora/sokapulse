export const metadata = {
  title: 'BetExplorer Jackpot Analysis & Predictions - SokaPulse',
  description: 'Sharp BetExplorer Jackpot Analysis with practical, human-written insights, value identification, and measured risk strategies.',
  alternates: {
    canonical: 'https://sokapulse.com/predictions/betexplorer-jackpot-analysis'
  },
  openGraph: {
    title: 'BetExplorer Jackpot Analysis & Predictions - SokaPulse',
    description: 'Sharp BetExplorer Jackpot Analysis with practical, human-written insights, value identification, and measured risk strategies.',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'BetExplorer Jackpot Analysis'
      }
    ],
    locale: 'en_US',
    type: 'website',
  ...
  twitter: {
    ...
    title: 'BetExplorer Jackpot Analysis & Predictions - SokaPulse',
    description: 'Human-written BetExplorer Jackpot Analysis with value angles and clear reasoning.',
  ...
  keywords: ['BetExplorer Jackpot Analysis', 'jackpot predictions', 'football predictions', 'betting tips', 'jackpot betting', 'SokaPulse'],
  colorScheme: 'light',
  viewport: {
    width: 'device-width',
    initialScale: 1,
  ...
  appleWebApp: {
    ...
    title: 'BetExplorer Jackpot Analysis - SokaPulse',
  },
  other: {
    'apple-mobile-web-app-capable': 'yes',
    'apple-mobile-web-app-status-bar-style': 'default',
    'apple-mobile-web-app-title': 'BetExplorer Jackpot Analysis - SokaPulse',
    'format-detection': 'telephone=no',
    'mobile-web-app-capable': 'yes',
    'application-name': 'BetExplorer Jackpot Analysis - SokaPulse',
  },
  datePublished: '2025-03-20T18:54:21+00:00',
  dateModified: new Date().toISOString(),
};

export default function BetExplorerJackpotAnalysisLayout({ children }) {
  return <>{children}</>;
} 