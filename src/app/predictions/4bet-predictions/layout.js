export const metadata = {
  title: '4bet Predictions & Expert Analysis - SokaPulse',
  ...
  alternates: {
    canonical: 'https://sokapulse.com/predictions/4bet-predictions'
  },
  openGraph: {
    title: '4bet Predictions & Expert Analysis - SokaPulse',
    description: 'Access expert 4bet football predictions with 85%+ accuracy. Comprehensive analysis across all major leagues and tournaments.',
  ...
  keywords: ['4bet predictions', 'football predictions', 'betting tips', 'sports analysis', 'jackpot betting', 'SokaPulse'],
  authors: [{ name: 'SokaPulse' }],
  colorScheme: 'light',
  viewport: {
    width: 'device-width',
  ...
  appleWebApp: {
    ...
    title: '4bet Predictions - SokaPulse',
  },
  other: {
    'apple-mobile-web-app-capable': 'yes',
    'apple-mobile-web-app-status-bar-style': 'default',
    'apple-mobile-web-app-title': '4bet Predictions - SokaPulse',
    'format-detection': 'telephone=no',
    'mobile-web-app-capable': 'yes',
    'application-name': '4bet Predictions - SokaPulse',
  },
  datePublished: '2025-03-20T18:54:21+00:00',
  dateModified: new Date().toISOString(),
};

export default function BetPredictionsLayout({ children }) {
  return <>{children}</>;
} 