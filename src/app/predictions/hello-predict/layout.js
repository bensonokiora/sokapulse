export const metadata = {
  title: 'hello-predict Football Predictions and Tips - sokapulse',
  ...
  keywords: 'hello-predict predictions, football tips, betting tips, football predictions, hello-predict football',
  openGraph: {
    title: 'hello-predict Football Predictions and Tips - sokapulse',
    type: 'website',
    url: '/predictions/hello-predict',
    images: [
      {
  ...
  twitter: {
    ...
    title: 'hello-predict Football Predictions and Tips - sokapulse',
    description: 'Get the latest hello-predict football predictions and tips for today\'s matches.',
    site: '@sokapulse'
  },
  alternates: {
    canonical: 'https://sokapulse.com/predictions/hello-predict'
  },
  other: {
    'article:publisher': [
...
export default function HelloPredictLayout({ children }) {
  return <>{children}</>;
}