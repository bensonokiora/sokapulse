export const metadata = {
  title: 'Mozzart Daily Jackpot Prediction',
  description: 'Sharp Mozzart daily jackpot prediction picks updated throughout the day. Clean analysis, confidence levels, and practical tips to improve your edge.',
  alternates: {
    canonical: 'https://sokapulse.com/predictions/mozzart-daily-jackpot-predictions'
  },
  openGraph: {
    title: 'Mozzart Daily Jackpot Prediction',
    description: 'Sharp Mozzart daily jackpot prediction picks updated throughout the day. Clean analysis, confidence levels, and practical tips to improve your edge.',
    url: 'https://sokapulse.com/predictions/mozzart-daily-jackpot-predictions',
    siteName: 'SokaPulse',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Mozzart Daily Jackpot Prediction'
      }
    ],
    locale: 'en_US',
    type: 'website',
  ...
  keywords: ['Mozzart daily jackpot prediction', 'Mozzart daily jackpot predictions', 'football predictions', 'jackpot betting', 'SokaPulse'],
  colorScheme: 'light',
  viewport: {
    width: 'device-width',
    initialScale: 1,
  ...
  appleWebApp: {
    ...
    title: 'Mozzart Daily Jackpot Prediction - SokaPulse',
  },
  other: {
    'apple-mobile-web-app-capable': 'yes',
    'apple-mobile-web-app-status-bar-style': 'default',
    'apple-mobile-web-app-title': 'Mozzart Daily Jackpot Prediction - SokaPulse',
    'format-detection': 'telephone=no',
    'mobile-web-app-capable': 'yes',
    'application-name': 'Mozzart Daily Jackpot Prediction - SokaPulse',
  },
  datePublished: '2025-07-28T18:54:21+00:00',
  dateModified: new Date().toISOString(),
};

export default function MozzartDailyJackpotPredictionLayout({ children }) {
  return <>{children}</>;
} 