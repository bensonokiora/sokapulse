export const metadata = {
  title: 'fcpredict Football Predictions and Tips - sokapulse',
  ...
  keywords: 'fcpredict predictions, football tips, betting tips, football predictions, fcpredict football',
  openGraph: {
    title: 'fcpredict Football Predictions and Tips - sokapulse',
    type: 'website',
    url: '/predictions/fcpredict',
    images: [
      {
  ...
  twitter: {
    ...
    title: 'fcpredict Football Predictions and Tips - sokapulse',
    description: 'Get the latest fcpredict football predictions and tips for today\'s matches.',
    site: '@sokapulse'
  },
  alternates: {
    canonical: 'https://sokapulse.com/predictions/fcpredict'
  },
  other: {
    'article:publisher': [
...
export default function FcpredictLayout({ children }) {
  return <>{children}</>;
}