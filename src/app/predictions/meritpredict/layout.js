export const metadata = {
  title: 'meritpredict Football Predictions and Tips - sokapulse',
  ...
  keywords: 'meritpredict predictions, football tips, betting tips, football predictions, meritpredict football',
  openGraph: {
    title: 'meritpredict Football Predictions and Tips - sokapulse',
    type: 'website',
    url: '/predictions/meritpredict',
    images: [
      {
  ...
  twitter: {
    ...
    title: 'meritpredict Football Predictions and Tips - sokapulse',
    description: 'Get the latest meritpredict football predictions and tips for today\'s matches.',
    site: '@sokapulse'
  },
  alternates: {
    canonical: 'https://sokapulse.com/predictions/meritpredict'
  },
  other: {
    'article:publisher': [
...
export default function MeritpredictLayout({ children }) {
  return <>{children}</>;
}