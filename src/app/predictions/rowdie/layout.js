export const metadata = {
  title: 'rowdie Football Predictions and Tips - sokapulse',
  ...
  keywords: 'rowdie predictions, football tips, betting tips, football predictions, rowdie football',
  openGraph: {
    title: 'rowdie Football Predictions and Tips - sokapulse',
    type: 'website',
    url: '/predictions/rowdie',
    images: [
      {
  ...
  twitter: {
    ...
    title: 'rowdie Football Predictions and Tips - sokapulse',
    description: 'Get the latest rowdie football predictions and tips for today\'s matches.',
    site: '@sokapulse'
  },
  alternates: {
    canonical: 'https://sokapulse.com/predictions/rowdie'
  },
  other: {
    'article:publisher': [
...
export default function RowdieLayout({ children }) {
  return <>{children}</>;
}