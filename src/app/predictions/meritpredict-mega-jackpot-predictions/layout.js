export const metadata = {
  title: 'MeritPredict Mega Jackpot Predictions - 17 Games Weekly Analysis',
  description:
    'MeritPredict Mega Jackpot predictions with transparent, human‑written reasoning for all 17 games updated weekly.',
  alternates: {
    canonical: 'https://sokapulse.com/predictions/meritpredict-mega-jackpot-predictions'
  },
  openGraph: {
    title: 'MeritPredict Mega Jackpot Predictions - 17 Games Weekly Analysis',
    description:
      'MeritPredict Mega Jackpot predictions with transparent, human‑written reasoning for all 17 games updated weekly.',
    url: 'https://sokapulse.com/predictions/meritpredict-mega-jackpot-predictions',
    siteName: 'SokaPulse',
    images: [
      { url: 'https://sokapulse.com/images/og-image.jpg', width: 1200, height: 630, alt: 'MeritPredict Mega Jackpot Predictions' }
    ],
    locale: 'en_US',
    type: 'website',
  },
  ...
  keywords: [
    'MeritPredict Mega Jackpot Predictions',
  ...
  appleWebApp: { capable: true, statusBarStyle: 'default', title: 'MeritPredict Mega Jackpot Predictions - SokaPulse' },
  other: {
    'apple-mobile-web-app-capable': 'yes',
    'apple-mobile-web-app-status-bar-style': 'default',
    'apple-mobile-web-app-title': 'MeritPredict Mega Jackpot Predictions - SokaPulse',
    'format-detection': 'telephone=no',
    'mobile-web-app-capable': 'yes',
    'application-name': 'MeritPredict Mega Jackpot Predictions - SokaPulse',
  },
  datePublished: '2025-03-20T18:54:21+00:00',
  dateModified: new Date().toISOString(),
};

export default function MeritpredictMegaJackpotPredictionLayout({ children }) {
  return <>{children}</>;
} 