export const metadata = {
  title: 'fizzley-tips Football Predictions and Tips - sokapulse',
  ...
  keywords: 'fizzley-tips predictions, football tips, betting tips, football predictions, fizzley-tips football',
  openGraph: {
    title: 'fizzley-tips Football Predictions and Tips - sokapulse',
    type: 'website',
    url: '/predictions/fizzley-tips',
    images: [
      {
  ...
  twitter: {
    ...
    title: 'fizzley-tips Football Predictions and Tips - sokapulse',
    description: 'Get the latest fizzley-tips football predictions and tips for today\'s matches.',
    site: '@sokapulse'
  },
  alternates: {
    canonical: 'https://sokapulse.com/predictions/fizzley-tips'
  },
  other: {
    'article:publisher': [
...
export default function FizzleyTipsLayout({ children }) {
  return <>{children}</>;
}