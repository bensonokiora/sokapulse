export const metadata = {
  title: 'WinDrawWin Mega Jackpot Predictions & Analysis - SokaPulse',
  description: 'Access human-written WinDrawWin Mega Jackpot Prediction insights backed by data-driven analysis. Fresh tips, expert reasoning, and practical guidance for mega jackpot betting.',
  alternates: {
    canonical: 'https://sokapulse.com/predictions/windrawwin-mega-jackpot-prediction'
  },
  openGraph: {
    title: 'WinDrawWin Mega Jackpot Predictions & Analysis - SokaPulse',
    description: 'Access human-written WinDrawWin Mega Jackpot Prediction insights backed by data-driven analysis. Fresh tips, expert reasoning, and practical guidance for mega jackpot betting.',
    url: 'https://sokapulse.com/predictions/windrawwin-mega-jackpot-prediction',
    siteName: 'SokaPulse',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'WinDrawWin Mega Jackpot Predictions'
      }
    ],
    locale: 'en_US',
    type: 'website',
  ...
  twitter: {
    ...
    title: 'WinDrawWin Mega Jackpot Predictions & Analysis - SokaPulse',
    description: 'Human-written WinDrawWin Mega Jackpot Prediction with expert analysis and weekly updates.',
  ...
  keywords: ['WinDrawWin Mega Jackpot Prediction', 'mega jackpot predictions', 'football predictions', 'betting tips', 'jackpot betting', 'SokaPulse'],
  colorScheme: 'light',
  viewport: {
    width: 'device-width',
    initialScale: 1,
  ...
  appleWebApp: {
    ...
    title: 'WinDrawWin Mega Jackpot Predictions - SokaPulse',
  },
  other: {
    'apple-mobile-web-app-capable': 'yes',
    'apple-mobile-web-app-status-bar-style': 'default',
    'apple-mobile-web-app-title': 'WinDrawWin Mega Jackpot Predictions - SokaPulse',
    'format-detection': 'telephone=no',
    'mobile-web-app-capable': 'yes',
    'application-name': 'WinDrawWin Mega Jackpot Predictions - SokaPulse',
  },
  datePublished: '2025-03-20T18:54:21+00:00',
  dateModified: new Date().toISOString(),
};

export default function WinDrawWinMegaJackpotPredictionLayout({ children }) {
  return <>{children}</>;
} 