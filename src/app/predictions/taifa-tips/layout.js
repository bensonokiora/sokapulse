export const metadata = {
  title: 'taifa-tips Football Predictions and Tips - sokapulse',
  ...
  keywords: 'taifa-tips predictions, football tips, betting tips, football predictions, taifa-tips football',
  openGraph: {
    title: 'taifa-tips Football Predictions and Tips - sokapulse',
    type: 'website',
    url: '/predictions/taifa-tips',
    images: [
      {
  ...
  twitter: {
    ...
    title: 'taifa-tips Football Predictions and Tips - sokapulse',
    description: 'Get the latest taifa-tips football predictions and tips for today\'s matches.',
    site: '@sokapulse'
  },
  alternates: {
    canonical: 'https://sokapulse.com/predictions/taifa-tips'
  },
  other: {
    'article:publisher': [
...
export default function TaifaTipsLayout({ children }) {
  return <>{children}</>;
}