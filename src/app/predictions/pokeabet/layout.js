export const metadata = {
  title: 'pokeabet Football Predictions and Tips - sokapulse',
  ...
  keywords: 'pokeabet predictions, football tips, betting tips, football predictions, pokeabet football',
  openGraph: {
    title: 'pokeabet Football Predictions and Tips - sokapulse',
    type: 'website',
    url: '/predictions/pokeabet',
    images: [
      {
  ...
  twitter: {
    ...
    title: 'pokeabet Football Predictions and Tips - sokapulse',
    description: 'Get the latest pokeabet football predictions and tips for today\'s matches.',
    site: '@sokapulse'
  },
  alternates: {
    canonical: 'https://sokapulse.com/predictions/pokeabet'
  },
  other: {
    'article:publisher': [
...
export default function PokeabetLayout({ children }) {
  return <>{children}</>;
}