export const metadata = {
  title: 'Betpawa Weekend Jackpot Prediction',
  description: 'Weekend-focused Betpawa jackpot prediction picks for Kenya, Tanzania, and Uganda. Clear analysis, confidence levels, and fast updates.',
  alternates: {
    canonical: 'https://sokapulse.com/predictions/betpawa-weekend-jackpot-predictions'
  },
  openGraph: {
    title: 'Betpawa Weekend Jackpot Prediction',
    description: 'Weekend-focused Betpawa jackpot prediction picks for Kenya, Tanzania, and Uganda. Clear analysis, confidence levels, and fast updates.',
    url: 'https://sokapulse.com/predictions/betpawa-weekend-jackpot-predictions',
    siteName: 'SokaPulse',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Betpawa Weekend Jackpot Prediction'
      }
    ],
    locale: 'en_US',
    type: 'website',
  ...
  keywords: ['Betpawa weekend jackpot prediction', 'Betpawa weekend jackpot predictions', 'Betpawa Kenya', 'Betpawa Tanzania', 'Betpawa Uganda', 'jackpot betting', 'SokaPulse'],
  colorScheme: 'light',
  viewport: {
    width: 'device-width',
    initialScale: 1,
  ...
  appleWebApp: {
    ...
    title: 'Betpawa Weekend Jackpot Prediction - SokaPulse',
  },
  other: {
    'apple-mobile-web-app-capable': 'yes',
    'apple-mobile-web-app-status-bar-style': 'default',
    'apple-mobile-web-app-title': 'Betpawa Weekend Jackpot Prediction - SokaPulse',
    'format-detection': 'telephone=no',
    'mobile-web-app-capable': 'yes',
    'application-name': 'Betpawa Weekend Jackpot Prediction - SokaPulse',
  },
  datePublished: '2025-07-28T18:54:21+00:00',
  dateModified: new Date().toISOString(),
};

export default function BetpawaWeekendJackpotPredictionLayout({ children }) {
  return <>{children}</>;
} 