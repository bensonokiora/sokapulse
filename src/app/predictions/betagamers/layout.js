export const metadata = {
  title: 'betagamers Football Predictions and Tips - sokapulse',
  ...
  keywords: 'betagamers predictions, football tips, betting tips, football predictions, betagamers football',
  openGraph: {
    title: 'betagamers Football Predictions and Tips - sokapulse',
    type: 'website',
    url: '/predictions/betagamers',
    images: [
      {
  ...
  twitter: {
    ...
    title: 'betagamers Football Predictions and Tips - sokapulse',
    description: 'Get the latest betagamers football predictions and tips for today\'s matches.',
    site: '@sokapulse'
  },
  alternates: {
    canonical: 'https://sokapulse.com/predictions/betagamers'
  },
  other: {
    'article:publisher': [
...
export default function BetagamersLayout({ children }) {
  return <>{children}</>;
}