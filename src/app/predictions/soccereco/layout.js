export const metadata = {
  title: 'soccereco Football Predictions and Tips - sokapulse',
  ...
  keywords: 'soccereco predictions, football tips, betting tips, football predictions, soccereco football',
  openGraph: {
    title: 'soccereco Football Predictions and Tips - sokapulse',
    type: 'website',
    url: '/predictions/soccereco',
    images: [
      {
  ...
  twitter: {
    ...
    title: 'soccereco Football Predictions and Tips - sokapulse',
    description: 'Get the latest soccereco football predictions and tips for today\'s matches.',
    site: '@sokapulse'
  },
  alternates: {
    canonical: 'https://sokapulse.com/predictions/soccereco'
  },
  other: {
    'article:publisher': [
...
export default function SoccerecoLayout({ children }) {
  return <>{children}</>;
}