export const metadata = {
  title: 'sporttips Football Predictions and Tips - sokapulse',
  ...
  keywords: 'sporttips predictions, football tips, betting tips, football predictions, sporttips football',
  openGraph: {
    title: 'sporttips Football Predictions and Tips - sokapulse',
    type: 'website',
    url: '/predictions/sporttips',
    images: [
      {
  ...
  twitter: {
    ...
    title: 'sporttips Football Predictions and Tips - sokapulse',
    description: 'Get the latest sporttips football predictions and tips for today\'s matches.',
    site: '@sokapulse'
  },
  alternates: {
    canonical: 'https://sokapulse.com/predictions/sporttips'
  },
  other: {
    'article:publisher': [
...
export default function SporttipsLayout({ children }) {
  return <>{children}</>;
}