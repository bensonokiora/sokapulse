...
export default function DoubleChancePredictionsClient({ 
  ...
  const renderPredictionNav = () => (
    <div className="match-details-navigation">
      ...
      <div className="match-details-nav-item">
        <Link href="/tomorrow-football-predictions/double-chance-predictions" className="match-details-nav-link active">
        ...
        {isExplanationVisible && (
          <>
            <p style={{ marginBottom: '8px' }}>
              Our algorithm analyzes team form, head-to-head records, and betting odds
              to predict the most likely double chance outcome (1X, X2, or 12).
            </p>
