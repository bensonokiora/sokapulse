...
export default function FavoritePredictions() {
...
<div className="match-details-navigation">
      <div className="match-details-nav-item">
        <Link href="/favourite-predictions" className="match-details-nav-link active">
          <span>1x2</span>
        </Link>
      </div>
      <div className="match-details-nav-item">
      ...
      <div className="match-details-nav-item">
        <Link href="/favourite-predictions/predictions-both-team-to-score" className="match-details-nav-link">
  ...
  const renderFixture = (fixture) => {
    ...
    const prediction = getPrediction(
      fixture.percent_pred_home.replace('%', ''),
      fixture.percent_pred_draw.replace('%', ''),
      fixture.percent_pred_away.replace('%', '')
    );
