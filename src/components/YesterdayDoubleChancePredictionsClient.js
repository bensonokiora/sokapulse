...
export default function YesterdayDoubleChancePredictionsClient({ 
  initialFixtures,
  initialError,
  initialNextCursor,
  perPage,
  ...
  const renderPredictionNav = () => (
    <div className="match-details-navigation">
      ...
      <div className="match-details-nav-item">
        <Link href="/yesterday-football-predictions/double-chance-predictions" className="match-details-nav-link active">
  ...
  const renderFixture = (fixture, index) => {
    ...
    return (
      <div key={fixture.id || index} className="responsive-row" style={{ cursor: 'auto' }}>
  ...
  return (
    <div className="row" style={{ marginLeft: '0px', height: 'auto !important' }}>
      <div className="col-lg-12" style={{ height: 'auto !important' }}>
        ...
        {isLoading ? (
        ...
        ) : fixtures.length === 0 && !loadMoreError ? (
          ...
          <>
            ...
            {!hasMore && !loadMoreError && allFixtures.length > 0 && (
