...
const sitemapPath = path.join(__dirname, '../public/fixtures-by-leagues-sitemap.xml');
...
fs.readFile(sitemapPath, 'utf8', (err, data) => {
  ...
  fs.writeFile(sitemapPath, updatedData, 'utf8', (err) => {
    ...
    console.log(`Successfully updated lastmod dates to ${today} in fixtures-by-leagues-sitemap.xml`);
  });
}); 